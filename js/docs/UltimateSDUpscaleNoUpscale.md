`Ultimate SD Upscale (No Upscale)` applies tiled image-to-image processing to an already upscaled image to enhance details and fix seams, without performing the initial upscaling step with an upscale model.
